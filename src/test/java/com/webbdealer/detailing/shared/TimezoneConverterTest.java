...
public class TimezoneConverterTest {
    ...
    public void fromUtcToLocalDateTime_Test() {
        ...
        LocalDateTime inputDateTime = LocalDateTime.parse("2021-03-13T22:04:00+00");
    ...
    public void fromLocalDateTimeToUtc_Test() {
        ...
        LocalDateTime outputDateTime = timezoneConverter.fromLocalDateTimeToUtc(inputDateTime);
